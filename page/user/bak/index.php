...
<div class="bs-docs-section">
									...
									<div class="col-lg-6">
										<p>请输入你的旅行项目暗号【发布者会提供给你】：</p>
											<div>
												...
												<button id="get_plan_submit" onclick="open_plan_detail($('#plan_id_in').val(),true)" class="form-control" type="button" disabled>请输入暗号</button>
												</span>
												</div>
											</div>
								</div>
				...
				<div id="create" style="display:none">
						<div class="panel panel-success">
							...
							<div class="panel-body">
								<div class="row">
									...
									<div class="col-lg-6">
												<div class='input-group'>
												<p>是否公开，如公开请留空，不公开请设置项目暗号</p>
												<div class='input-group'>
												<input name="plan_id" id="plan_id_in" oninput="check_plan(this.value)" type="text" placeholder="项目暗号" class="form-control">
												<span class="input-group-btn">
												<button id="check_plan_submit" onclick="open_plan_detail($('#plan_id_in').val(),true)" class="form-control" type="button" disabled>请输入暗号</button>
												</span>
												</div>
												<div id='errmsg_post' style=”font-family:Microsoft YaHei,Arial;color:#E00;margin-top:10px;“></div>
												<br />
												<button class="btn btn-success btn-lg" name="change" value="edit" id="post_plan_submit" type="submit">发　布</button>
					...
					<div id="travel_list">
										<table class="table table-hover">
											...
											if ($travel['plan_id']){
											echo '-';}else{
												echo "<a class='btn btn-primary' role='button' onclick='open_plan_enrol_panel('$travel[id]')'>查看详情 &raquo;</a>";
											}?>
												</td>	
											  </tr>
											</tbody>
	...
	<td>
		<a href="javascript:void(0);" onclick="open_plan_detail('<?=$travel['plan_id']?>')">查看详情</a> | 
		<a target="_attach" href="attachment/attach.php?id=<?=$result['id']?>")>附件</a>
		</td>	
	  </tr>
	</tbody>
			<?}}?>
  ...
  <hr />
	...
	<td>
		<a href="javascript:void(0);" onclick="open_plan_detail('<?=$result['plan_id']?>')">编辑</a>
		| <a href="javascript:void(0);" onclick="open_plan_detail('<?=$result['plan_id']?>')">数据</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
	   			<button id="cancel" type="button" class="btn btn-danger">取消报名</button>
	   			<button id="enrol_b" type="button" class="btn btn-primary">报名</button>
	 		</div>
		</div>
	</div>
</div>
